...
public class ThankfulChestAnimation extends TreasureOpenAnimation
{
	...
	public ThankfulChestAnimation(Treasure treasure, TreasureLocation treasureLocation)
	{
	...
	{
		changeFloor(Material.WOOL, 12, Material.WOOL, 4);
