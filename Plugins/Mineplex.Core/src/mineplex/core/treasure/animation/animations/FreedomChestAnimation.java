...
public class FreedomChestAnimation extends TreasureOpenAnimation
{
	...
	public FreedomChestAnimation(Treasure treasure, TreasureLocation treasureLocation)
	{
	...
	{
		changeFloor(Material.WOOL, 14, Material.WOOL, 11);
