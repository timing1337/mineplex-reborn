	...
	Christmas(Christmas.class, GameDisplay.Christmas, new Pair[] 
			{
				//Pair.create(MinecraftVersion.ALL, "http://file.mineplex.com/ResChristmas.zip")
					Pair.create(MinecraftVersion.Version1_8, "https://up.nitro.moe/mineplex/ResChristmasChaos18.zip"),
					Pair.create(MinecraftVersion.Version1_9, "https://up.nitro.moe/mineplex/ResChristmasChaos19.zip"),
					Pair.create(MinecraftVersion.Version1_13, "https://up.nitro.moe/mineplex/ResChristmasChaos113.zip")
			}, true),
	ChristmasNew(ChristmasNew.class, GameDisplay.ChristmasNew, new Pair[]
			{
				...
				//Pair.create(MinecraftVersion.Version1_9, "http://file.mineplex.com/ResChristmas219.zip")
					Pair.create(MinecraftVersion.Version1_8, "https://up.nitro.moe/mineplex/ResChristmasChaos218.zip"),
					Pair.create(MinecraftVersion.Version1_9, "https://up.nitro.moe/mineplex/ResChristmasChaos219.zip"),
					Pair.create(MinecraftVersion.Version1_13, "https://up.nitro.moe/mineplex/ResChristmasChaos2113.zip")
			}, false),
	...
	Draw(Draw.class, GameDisplay.Draw, new Pair[]
			{
				//Pair.create(MinecraftVersion.ALL, "http://file.mineplex.com/ResDrawMyThing.zip")
					Pair.create(MinecraftVersion.Version1_8, "https://up.nitro.moe/mineplex/ResDrawMyThing18.zip"),
					Pair.create(MinecraftVersion.Version1_9, "https://up.nitro.moe/mineplex/ResDrawMyThing19.zip"),
	...
	Halloween(Halloween.class, GameDisplay.Halloween, new Pair[] 
			{
				//Pair.create(MinecraftVersion.ALL, "http://file.mineplex.com/ResHalloween.zip")
					Pair.create(MinecraftVersion.Version1_8, "https://up.nitro.moe/mineplex/ResHalloween18.zip"),
					Pair.create(MinecraftVersion.Version1_9, "https://up.nitro.moe/mineplex/ResHalloween19.zip"),
					Pair.create(MinecraftVersion.Version1_13, "https://up.nitro.moe/mineplex/ResHalloween113.zip")
			}, true),
	...
	MineStrike(Minestrike.class, GameDisplay.MineStrike, new Pair[] 
			{
				...
				Pair.create(MinecraftVersion.Version1_8, "https://up.nitro.moe/mineplex/ResMinestrike3D18.zip"),
				Pair.create(MinecraftVersion.Version1_9, "https://up.nitro.moe/mineplex/ResMinestrike3D19.zip"),
				Pair.create(MinecraftVersion.Version1_13, "https://up.nitro.moe/mineplex/ResMinestrike3D113.zip")
			}, true),
	...
	Wizards(Wizards.class, GameDisplay.Wizards, new Pair[] 
			{
				...
				Pair.create(MinecraftVersion.Version1_8, "https://up.nitro.moe/mineplex/ResWizards3D18.zip"),
					Pair.create(MinecraftVersion.Version1_9, "https://up.nitro.moe/mineplex/ResWizards3D19.zip"),
					Pair.create(MinecraftVersion.Version1_13, "https://up.nitro.moe/mineplex/ResWizards3D113.zip"),
			}, true),
	...
	BattleRoyale(BattleRoyaleSolo.class, GameDisplay.BattleRoyale, new Pair[]
			{
				...
				Pair.create(MinecraftVersion.Version1_13, "https://up.nitro.moe/mineplex/ResStrikeGames113.zip"),
			}, true),
